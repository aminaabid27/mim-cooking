  ...
  return (
    <header className="relative overflow-hidden animate-slide-in-down">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-2 sm:left-10 w-40 h-40 sm:w-72 sm:h-72 bg-amber-500/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-2 sm:right-10 w-40 h-40 sm:w-72 sm:h-72 bg-orange-500/20 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="relative max-w-6xl mx-auto px-2 sm:px-4 py-8 sm:py-12 md:py-20">
        <div className="text-center">
          ...
          <div className="mb-6 inline-block">
            <div className="glass-effect px-4 py-2 rounded-full text-xs sm:text-sm font-bold text-amber-300 uppercase tracking-[0.2em]">
              Authentic Homemade Cuisine
            </div>
          </div>

          {/* Main Title */}
          <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black mb-4 gradient-text animate-float px-2">
            M&M Cooking
          </h1>

          {/* Tagline */}
          <p className="text-lg sm:text-xl md:text-2xl text-amber-200 mb-8 font-light tracking-wide px-4">
            Home of Authentic Flavours
          </p>

          {/* Location */}
          <div className="flex flex-col items-center gap-4 mb-10 px-4">
            <div className="glass-effect px-5 sm:px-8 py-3 rounded-2xl text-xs sm:text-sm md:text-base text-slate-200 font-medium max-w-[90vw] sm:max-w-none">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 flex-wrap">
            ...
            <a
              ...
              className="glass-effect px-4 sm:px-6 py-3 rounded-xl text-green-300 hover:text-green-200 font-bold transition-all duration-300 hover:scale-110 glow-effect group"
            >
            ...
            <div className="flex items-center gap-3 sm:gap-4 mt-2 md:mt-0">
              <a
                ...
                className="glass-effect p-2 sm:p-3 rounded-full text-blue-300 hover:text-blue-200 hover:scale-125 transition-all duration-300 glow-effect"
              >
              ...
              <a
                ...
                className="glass-effect p-2 sm:p-3 rounded-full text-pink-300 hover:text-pink-200 hover:scale-125 transition-all duration-300 glow-effect"
              >
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
