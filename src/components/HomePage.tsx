...
export default function HomePage({ initialTab = 'order' }: HomePageProps) {
          ...
          <div className="sticky top-0 z-30 -mx-3 mb-6 border-y border-white/10 bg-slate-950/90 px-3 py-3 backdrop-blur-xl sm:mx-0 sm:rounded-2xl sm:border lg:top-4">
            <div className="grid grid-cols-4 gap-2">
              <button
                ...
                className={`min-h-12 rounded-xl px-1 py-3 text-[0.68rem] font-black transition-colors sm:px-4 sm:text-lg ${
                  activeTab === 'order'
