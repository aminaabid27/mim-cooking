...
export const frozenItems: MenuItem[] = [
  ...
  { id: 'frozen-4', name: 'Chicken Seekh Kabab (12 pcs)', price: 770, category: 'frozen' },
  { id: 'frozen-5', name: 'Chicken Chapli Kabab (12 pcs)', price: 820, category: 'frozen' },
  { id: 'frozen-6', name: 'Chicken Kofta (12 pcs)', price: 570, category: 'frozen' },
  { id: 'frozen-7', name: 'Beef Keema Samosa (12 pcs)', price: 770, category: 'frozen' },
...
export const italianFavourites: MenuItem[] = [
  ...
  { id: 'italian-7', name: 'White Sauce Pasta (Small)', price: 570, category: 'italian' },
  { id: 'italian-8', name: 'White Sauce Pasta (Large)', price: 870, category: 'italian' },
  { id: 'italian-9', name: 'Red Sauce Pasta (Small)', price: 540, category: 'italian' },
  { id: 'italian-10', name: 'Red Sauce Pasta (Large)', price: 840, category: 'italian' },
  { id: 'italian-11', name: 'Loaded Fries (Small)', price: 570, category: 'italian' },
