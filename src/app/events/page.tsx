...
export const metadata: Metadata = {
  title: 'Events & Catering | M&M Cooking',
  description:
    'Book M&M Cooking for food stalls, birthday parties, office lunches, family gatherings, and custom catering in Islamabad and Rawalpindi.',
};
